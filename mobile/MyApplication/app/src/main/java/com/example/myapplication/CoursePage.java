                ...
                if ((cou.get_date().getTime()-curDate.getTime())/(60*60*1000)>=1){
                    ...
                    if(rs.getRow()==0) {
                        if(cou.get_applicants()==cou.get_capacity()){
                            ...
                            View view1 = View.inflate(CoursePage.this, R.layout.alert, null);
                            Looper.prepare();
                            final Looper looper = Looper.myLooper();
                            AlertDialog alertDialog1 = new AlertDialog.Builder(CoursePage.this)
                                    .setTitle("Payment.")
                                    .setView(view1)
                                    ...
                                    .setPositiveButton("ok", new DialogInterface.OnClickListener() {//添加"Yes"按钮
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            ...
                                            Toast.makeText(CoursePage.this, "Book successfully", Toast.LENGTH_SHORT).show();
                                        }
                                    })
                                    .create();
                            alertDialog1.show();
