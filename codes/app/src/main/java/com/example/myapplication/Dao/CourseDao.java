...
public class CourseDao {
    ...
    public List<Course> findcourse(String username){
        ...
        String sql1 = "select * from course where idcourse = ?";
        ...
        try {
            ...
            if(!rs.next()){
                ...
                String y = "No course!";
                Date z = new Date();
                Course course = new Course(x, y, z, 0, 0, "a", 0, 0, "asd");
                ...
                while(i.hasNext()) {
                    ...
                    int count = rs1.getInt(5);
                    String category = rs1.getString(6);
                    int duration = rs1.getInt(7);
                    int calorie = rs1.getInt(8);
                    String description = rs1.getString(9);
                    Course course = new Course(id1, coursename, date, capacity, count, category, duration, calorie, description);
                    courselist.add(course);
                }
            }
